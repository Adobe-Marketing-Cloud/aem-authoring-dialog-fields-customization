...
.. granite:servercomponent:: /apps/cqgems/customizingfield/components/colorpicker2
   ...
   .. gnd:gnd::
      ...
      [cqgems:ColorPicker2] > granite:FormField
...
###--%><%
    ...
    attrs.addClass("granite-example-colorpicker2");
